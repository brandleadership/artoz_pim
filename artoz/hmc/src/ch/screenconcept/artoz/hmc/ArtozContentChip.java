...
/**
 * Implements methods for displaying a artoz content chip.
 *
 * @author  ExtGen v3.0
 * @version ExtGen v3.0 */
 
public class ArtozContentChip extends AbstractChip
{
	//Log4J implementation - edit project.properties file's Logging section to configurate your own log channel
	static final Logger log = Logger.getLogger( ArtozContentChip.class.getName() );
	
	public ArtozContentChip(DisplayState displayState, Chip parent)
	{
	...
	{
		return "/ext/artoz/ArtozContentChip.jsp";
	}
